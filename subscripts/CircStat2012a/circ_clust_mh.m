function [cid, alpha, mu, mindist_track] = circ_clust_mh(alpha, numclust, disp)
%
...
mindist_track=[]; %added by Miriam Henning to keep track of distance between clusters
while(num_unique > num_clusters_wanted)
    ...
    mindist_track=[mindist_track,mindist]; %added by Miriam Henning
