...
function Z= averageDirectionVectors_Zdepth_8dirEdge(T4T5_mb,Zdepth)
...
Z_T5A_mean=[];Z_T5B_mean=[];Z_T5C_mean=[];Z_T5D_mean=[];
Z_T4A_mean=[];Z_T4B_mean=[];Z_T4C_mean=[];Z_T4D_mean=[];

Z_T5A_std=[];Z_T5B_std=[];Z_T5C_std=[];Z_T5D_std=[];
Z_T4A_std=[];Z_T4B_std=[];Z_T4C_std=[];Z_T4D_std=[];

Z_T5A_circstd=[];Z_T5B_circstd=[];Z_T5C_circstd=[];Z_T5D_circstd=[];
Z_T4A_circstd=[];Z_T4B_circstd=[];Z_T4C_circstd=[];Z_T4D_circstd=[];

Z_T5A_circste=[];Z_T5B_circste=[];Z_T5C_circste=[];Z_T5D_circste=[];
Z_T4A_circste=[];Z_T4B_circste=[];Z_T4C_circste=[];Z_T4D_circste=[];


for NFlies= 1:length(T4T5_mb)
    
    if T4T5_mb(NFlies).z_depth==Zdepth
     % T5-------------------------------------------------
